    ...
    <aside className="flex h-full w-64 shrink-0 flex-col justify-between bg-[#2f63d8] p-4 shadow-[8px_0_28px_-14px_rgba(30,64,175,0.45)]">
      <div>
        <div className="border-b border-white/15 px-3 pb-6 pt-3">
          <h2 className="text-base font-bold leading-none tracking-tight text-white">Admin Portal</h2>
          <p className="mt-1.5 text-xs font-medium text-blue-100/80">UniCareer HQ</p>
        </div>
        ...
        <nav className="mt-5 space-y-1.5">
          ...
          <button
            ...
            className={`flex w-full items-center gap-3.5 px-3.5 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ${
              activeTab === 'users'
                ? 'bg-white text-[#2455c5] shadow-[0_5px_12px_-7px_rgba(15,23,42,0.45)]'
                : 'text-blue-50/90 hover:bg-white/12 hover:text-white'
            }`}
